...
kubectl apply -f /home/ec2-user/laboratorio_ci_cd/k8s/deployment.yaml -n $NAMESPACE

# Aplicar el servicio a Minikube
kubectl apply -f /home/ec2-user/laboratorio_ci_cd/k8s/service.yaml -n $NAMESPACE
